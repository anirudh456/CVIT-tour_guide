...
from runtime.components.guard.show_user_details.show_user_details import ShowDetails
...
class TestHarness(TestCase):
    ...
    def setUp(self):
        ...
        self.component.add_cmd_handler(Cmd.show_user_details, ShowDetails.do)
