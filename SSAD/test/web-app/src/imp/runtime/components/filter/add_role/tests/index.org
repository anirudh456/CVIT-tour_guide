#+title: Test Setup for Add-Role Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-08-30 Wed]
...
* Test Harness
  ...
  Instantiates a =Filter= component and populates it with the
  =AddRole= command handler. 
...
tests on the =add_role= route for the filter component. 

 - creates an entity manager
 - creates a engine component with that entity manager
 - adds the =add_role='s command handler (=AddRole.do=)
