#+title: Test Setup for Add-Users Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-04-11 Tue]
...
* Test Harness
  ...
  Instantiates a =Filter= component and populates it with the =ShowUser= command
  handler.
...
tests on the =add_user= route for the engine component. 

 - creates an entity manager
 - creates a filter component with that entity manager
 - adds the =add_user='s command handler (=AddUser.do=)
...
print "runtime.components.filter.add_user.tests package"
#+END_SRC
