...
* Test Harness
  ...
  Instantiates a =Filter= component and populates it with the =GetUser= command
  handler.
...
tests on the =get_user_by_email= route for the filter component. 

 - creates an entity manager
 - creates a filter component with that entity manager
