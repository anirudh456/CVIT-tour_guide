#+title: Test Setup for get_roles_of_user Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-10 Mon]
...
* Test Harness
  ...
  Instantiates a =Engine= component and populates it with the =GetRoles= command
  handler.
...
tests on the =get_roles_of_user= route for the engine component. 
