...
* Test Harness
  ...
  Instantiates a =Engine= component and populates it with the =ShowDetails= command
  handler.
...
tests on the =show_user_details= route for the engine component. 

 - creates an entity manager
 - creates a engine component with that entity manager
 - adds the =show_user_details='s command handler (=ShowDetails.do=)
