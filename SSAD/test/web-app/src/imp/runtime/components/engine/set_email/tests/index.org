#+title: Test Setup for Set-Email Del User Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-3 Mon]
...
tests on the =set_email= route for the engine component. 

 - creates an entity manager
 - creates a engine component with that entity manager
 - adds the =set_email='s command handler (=SetEmail.do=)
...
print "runtime.components.engine.set_email.tests package"
#+END_SRC
