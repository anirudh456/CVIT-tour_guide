#+title: Test Setup for Show-Sessions Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-3 Mon]
...
tests on the =show_sessions= route for the engine component. 

 - creates an entity manager
 - creates a engine component with that entity manager
 - adds the =show_sessions='s command handler (=ShowSessions.do=)
