#+title: Test Setup for Set-Name Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-3 Mon]
...
tests on the =set_name= route for the guard component. 

 - creates an entity manager
 - creates a guard component with that entity manager
 - adds the =set_name='s command handler (=SetName.do=)
...
print "runtime.components.guard.set_name.tests package"
#+END_SRC
