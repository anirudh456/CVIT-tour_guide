#+title: Test Setup for =show_user_details= Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-10 Mon]
...
=show_user_details= command handler. 
...
tests on the =show_user_details= route for the guard component. 

 - creates an entity manager
 - creates a guard component with that entity manager
 - adds the =show_user_details='s command handler (=ShowDetails=)
...
print "runtime.components.guard.show_user_details.tests package"
#+END_SRC
