#+title: Test on set_name route with wrong type of arguments
#+AUTHOR: VLEAD
#+DATE: [2017-07-3 Mon]
...
* Test 
  =TestSetName= object holds an instance of the =SetName= component against
...
** Test Case
   ...
   instruction with cmd =set_name= and a session that is not of type
