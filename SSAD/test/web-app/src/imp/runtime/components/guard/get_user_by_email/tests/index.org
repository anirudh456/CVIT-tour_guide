#+title: Test Setup for get_user_by_email Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-6 Thu]
...
=get_user_by_email= command handler. 
...
tests on the =get_user_by_email= route for the guard component. 

 - creates an entity manager
 - creates a guard component with that entity manager
 - adds the =get_user_by_email='s command handler (=GetUser=)
...
print "runtime.components.guard.get_user_by_email.tests package"
#+END_SRC
