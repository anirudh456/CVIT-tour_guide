#+title: Test on show_sessions route with wrong type of arguments
#+AUTHOR: VLEAD
#+DATE: [2017-07-3 Mon]
...
* Test 
  =TestShowSessions= object holds an instance of the =ShowSessions= component
...
** Test Case
   ...
   instruction with cmd =show_sessions= and a session that is not of type
