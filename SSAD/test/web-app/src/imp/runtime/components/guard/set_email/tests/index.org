#+title: Test Setup forSet-Email Del User Command Handler
#+AUTHOR: VLEAD
#+DATE: [2017-07-3 Mon]
...
tests on the =set_email= route for the guard component. 
...
print "runtime.components.guard.set_email.tests package"
#+END_SRC
